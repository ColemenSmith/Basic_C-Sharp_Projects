...
namespace ExcelToSql {
    ...
    public partial class dbDemoDataSet : global::System.Data.DataSet {
        ...
        public partial class EmployeesDataTable : global::System.Data.TypedTableBase<EmployeesRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public EmployeesRow AddEmployeesRow(int _0, string FirstName, string LastName, string Gender, string Country, int Age, System.DateTime Date, int Id) {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public EmployeesRow FindBy_0(int _0) {
        ...
        public partial class EmployeesRow : global::System.Data.DataRow {
            ...
            public int _0 {
                get {
                    return ((int)(this[this.tableEmployees._0Column]));
                }
                set {
                    this[this.tableEmployees._0Column] = value;
                }
            }
...
namespace ExcelToSql.dbDemoDataSetTableAdapters {
    ...
    public partial class EmployeesTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM [dbo].[Employees] WHERE (([0] = @p2) AND ([FirstName] = @Original_FirstName) AND ([LastName] = @Original_LastName) AND ([Gender] = @Original_Gender) AND ([Country] = @Original_Country) AND ([Age] = @Original_Age) AND ([Date] = @Original_Date) AND ([Id] = @Original_Id))";
            ...
            this._adapter.InsertCommand.CommandText = @"INSERT INTO [dbo].[Employees] ([0], [FirstName], [LastName], [Gender], [Country], [Age], [Date], [Id]) VALUES (@p1, @FirstName, @LastName, @Gender, @Country, @Age, @Date, @Id);
SELECT [0], FirstName, LastName, Gender, Country, Age, Date, Id FROM Employees WHERE ([0] = @_)";
...
SELECT [0], FirstName, LastName, Gender, Country, Age, Date, Id FROM Employees WHERE ([0] = @_)";
        ...
        public virtual int Fill(dbDemoDataSet.EmployeesDataTable dataTable) {
        ...
        public virtual dbDemoDataSet.EmployeesDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            dbDemoDataSet.EmployeesDataTable dataTable = new dbDemoDataSet.EmployeesDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(dbDemoDataSet.EmployeesDataTable dataTable) {
        ...
        public virtual int Delete(int p2, string Original_FirstName, string Original_LastName, string Original_Gender, string Original_Country, int Original_Age, System.DateTime Original_Date, int Original_Id) {
        ...
        public virtual int Insert(int p1, string FirstName, string LastName, string Gender, string Country, int Age, System.DateTime Date, int Id, int _) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string FirstName, string LastName, string Gender, string Country, int Age, System.DateTime Date, int Id, int p2, string Original_FirstName, string Original_LastName, string Original_Gender, string Original_Country, int Original_Age, System.DateTime Original_Date, int Original_Id) {
